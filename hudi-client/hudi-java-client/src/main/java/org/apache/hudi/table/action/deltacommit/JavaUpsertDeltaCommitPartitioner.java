 ...
 */
public class JavaUpsertDeltaCommitPartitioner extends JavaUpsertPartitioner {

  public JavaUpsertDeltaCommitPartitioner(WorkloadProfile profile, HoodieEngineContext context, HoodieTable table,
